...
export const alumniMembers: Member[] = [
  { name: '七月逗', avatarKey: '七月逗.jpeg', role: '组长' },
  { name: '七月喵', avatarKey: '七月喵.jpeg', role: '组长' },
  { name: '七月丫', avatarKey: '七月丫.jpeg', role: '组长' },
  { name: 'Spica', avatarKey: 'Spica.jpeg', role: '总务组成员' },
  { name: '七月烧', avatarKey: '七月烧.jpeg', role: '群务组监督' },
  { name: '七月凡', avatarKey: '七月凡.jpeg', role: '总务组成员' },
  { name: '七月Toy', avatarKey: '七月Toy.jpeg', role: '专务' },
  { name: '七月希', avatarKey: '七月希.jpeg', role: '总务组成员' },
  { name: '七月钗', avatarKey: '七月钗.jpeg', role: '总务组成员' },
  { name: '七月铝', avatarKey: '七月铝.jpeg', role: '专务 / 顾问组成员' },
  { name: '七月雨', avatarKey: '七月雨.jpeg', role: '总务组成员' },
  { name: '七月九', avatarKey: '七月九.jpeg', role: '群务组组长' },
  { name: '本群最弱玩家', avatarKey: '本群最弱玩家.jpeg', role: '18级管理' },
  { name: '道德同志', avatarKey: '道德同志.jpeg', role: '18级管理' },
  { name: 'L.I', avatarKey: 'L.I.jpeg', role: '18级管理' },
  { name: '面条', avatarKey: '面条.jpeg', role: '18级管理' },
  { name: '源泉', avatarKey: '源泉.jpeg', role: '18级管理' },
  { name: '无逸', avatarKey: '无逸.jpeg', role: '18级管理' },
  { name: '七月湦', avatarKey: '七月湦.jpeg', role: '18级管理' },
  { name: '观澜千代', avatarKey: '观澜千代.jpeg', role: '信息群管理' },
  { name: '七月上', avatarKey: '七月上.jpeg', role: '群务组成员' },
  { name: '海豹', avatarKey: '海豹.jpeg', role: '群务组成员' },
  { name: '七月悠', avatarKey: '七月悠.jpeg', role: '组长' },
  { name: '七月糊-又', avatarKey: '七月糊-又.jpeg', role: '总务组专务' },
  { name: '七月哔', avatarKey: '七月哔.jpeg', role: '顾问组成员' },
  { name: '乾坤胤', avatarKey: '乾坤胤.jpeg', role: '顾问组成员' },
