...
export const generalMembers: Member[] = [
  {
    name: "七月花",
    avatarKey: "七月花.jpg",
    desc: "team.members.julyHua.desc",
    dream: "team.members.julyHua.dream",
  },
  {
    name: "七月知更鸟",
    avatarKey: "七月知更鸟.jpeg",
    desc: "team.members.julyRobin.desc",
  },
  {
    name: "七月阿鸿",
    avatarKey: "七月阿鸿.jpeg",
    desc: "team.members.julyAhong.desc",
  },
  {
    name: "七月墨染",
    avatarKey: "七月墨染.png",
    ...
    members: [
      {
        name: "七月止水",
        avatarKey: "七月止水.png",
        desc: "team.members.julyZhishui.desc",
      },
      {
        name: "七月清汉",
        avatarKey: "七月清汉.png",
    ...
    members: [
      {
        ...
        desc: "team.members.julyBadragon.desc",
      },
      {
        name: "七月三七",
        avatarKey: "七月三七.jpeg",
      ...
      },
      {
        ...
        desc: "team.members.julyEcho.desc",
      },
    ],
  },
  junior2: {
    ...
    members: [
      {
        name: "七月十一",
        avatarKey: "七月十一.jpg",
        desc: "team.members.julyShiyi.desc",
      },
    ],
  },
  language: {
  ...
  production: {
    ...
    members: [
      ...
      },
      {
        name: "七月一前",
        avatarKey: "七月一前.png",
        desc: "team.members.julyYiqian.desc",
      },
      {
        name: "七月孙",
        avatarKey: "七月孙.jpg",
...
export const professionalSubGroups: Record<string, SubGroup> = {
  math: {
    ...
    members: [
      {
        name: "七月Bcent",
        avatarKey: "七月Bcent.jpeg",
        desc: "team.members.julyBcent.desc",
      },
      {
        name: "七月阿泠",
        avatarKey: "七月阿泠.jpeg",
      ...
      },
      {
        name: "七月彼方",
        avatarKey: "七月彼方.jpeg",
        desc: "team.members.julyBifang.desc",
      },
      {
        name: "七月有珠",
        avatarKey: "七月有珠.jpeg",
      ...
      },
      {
        ...
        desc: "team.members.julyLichlet.desc",
      },
      {
        name: "七月胡冰阳",
  ...
  chemistry: {
    ...
    members: [
      ...
      },
      {
        name: "七月三尺水",
        avatarKey: "七月三尺水.jpg",
        desc: "team.members.julySanchishui.desc",
      },
    ],
  },
  biology: {
  ...
  textbooks: {
    ...
    members: [
      ...
      },
      {
        ...
        desc: "team.members.julyJoshua.desc",
      },
      {
        name: "七月",
        avatarKey: "七月.png",
...
export const alumniMembers: Member[] = [
  ...
  { name: "Spica", role: "team.roles.generalMember" },
  {
    name: "七月烧",
    avatarKey: "七月烧.jpg",
    role: "team.roles.affairsSupervisor",
  },
  ...
  { name: "七月钗", avatarKey: "七月钗.jpg", role: "team.roles.generalMember" },
  {
    name: "七月铝",
    avatarKey: "七月铝.jpg",
    role: "team.roles.specialistAdvisor",
  },
  { name: "七月雨", role: "team.roles.generalMember" },
  {
    name: "七月九",
    avatarKey: "七月九.jpg",
    role: "team.roles.affairsGroupLeader",
  },
  {
    name: "本群最弱玩家",
    avatarKey: "本群最弱玩家.jpg",
    role: "team.roles.level18Admin",
  },
  {
    name: "道德同志",
    avatarKey: "道德同志.jpg",
  ...
  { name: "七月湦", avatarKey: "七月湦.jpg", role: "team.roles.level18Admin" },
  {
    name: "观澜千代",
    avatarKey: "观澜千代.jpg",
    role: "team.roles.infoGroupAdmin",
  },
  ...
  { name: "七月悠", avatarKey: "七月悠.jpg", role: "team.roles.groupLeader" },
  {
    name: "七月糊-又",
    avatarKey: "七月糊-又.jpg",
    role: "team.roles.generalSpecialist",
  },
