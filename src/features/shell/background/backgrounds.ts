...
export const BACKGROUNDS: BackgroundMeta[] = [
  {
    ...
    theme: 'both',
    preload: true,
    load: () => import('./lib-vue/AuroraBackground.vue'),
  ...
  },
  {
    ...
    icon: '🔢',
    theme: 'dark',
    load: () => import('./lib-vue/BinaryMatrixBackground.vue'),
  ...
  },
  {
    ...
    icon: '✨',
    theme: 'both',
    load: () => import('./lib-vue/ConstellationFieldBackground.vue'),
  ...
  },
  {
    ...
    icon: '💧',
    theme: 'dark',
    load: () => import('./lib-vue/DataRainBackground.vue'),
    darkProps: { color: 'rgba(0,255,65,0.8)', rippleColor: 'rgba(0,255,65,0.5)' },
  },
  {
    id: 'dna-spark',
    ...
    icon: '🧬',
    theme: 'dark',
    load: () => import('./lib-vue/DNASparkBackground.vue'),
  ...
  },
  {
    ...
    icon: '🧬',
    theme: 'dark',
    load: () => import('./lib-vue/DNASparkBackground3D.vue'),
    darkProps: { sparkColor: '#5e6ad2', strandColor: '#818cf8' },
  },
  {
    id: 'dreamy-halo',
    ...
    icon: '💫',
    theme: 'light',
    load: () => import('./lib-vue/DreamyHaloBackground.vue'),
  ...
  },
  {
    ...
    icon: '💨',
    theme: 'dark',
    load: () => import('./lib-vue/FluidSmokeFlowBackground.vue'),
  ...
  },
  {
    ...
    icon: '🪐',
    theme: 'dark',
    load: () => import('./lib-vue/OrbitClusterBackground.vue'),
  ...
  },
  {
    ...
    icon: '⚛',
    theme: 'both',
    load: () => import('./lib-vue/ParticlesBackground.vue'),
  ...
  },
  {
    ...
    icon: '🕸',
    theme: 'dark',
    load: () => import('./lib-vue/QuantumWebBackground.vue'),
  ...
  },
  {
    ...
    icon: '🔤',
    theme: 'both',
    load: () => import('./lib-vue/TextParticlesBackground.vue'),
