...
<template>
  ...
  >
    ...
    <input
      ...
      @focus="() => { search(keywordDesktop, true); document.getElementById('navbar')?.setAttribute('data-search-expanded', ''); }"
      @blur="() => { document.getElementById('navbar')?.removeAttribute('data-search-expanded'); }"
