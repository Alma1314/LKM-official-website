  ...
  <div class="max-w-lg mx-auto">
    ...
    <div class="flex gap-2">
      <textarea
        ...
        rows="2"
        class="flex-1 px-3 py-2 rounded-lg bg-gray-800/50 border border-amber-800/30 text-gray-200 text-sm focus:border-amber-700/50 outline-none placeholder-gray-500 resize-none"
        placeholder="写下你的回信..."
      ></textarea>
      <button
        class="px-4 py-2 rounded-lg bg-amber-900/40 border border-amber-800/50 text-amber-300 text-sm font-medium hover:bg-amber-900/50 transition-colors shrink-0"
