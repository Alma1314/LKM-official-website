    ...
    <div class="app-root">
      ...
      <header class="top-nav glass">
        <div class="nav-inner">
          ...
          <div class="nav-actions">
            <a href="/treehole/write" class="btn-grad nav-write-btn active-nav-btn">✍️ 写信</a>
      ...
      <transition name="slide-down">
        <nav v-if="mobileMenuOpen" class="mobile-menu glass" aria-label="移动端导航" @click="mobileMenuOpen = false">
          ...
          <a href="/treehole/write" class="mobile-nav-link active">✍️ 写信</a>
        ...
        <div class="container">
          ...
          <div class="write-grid">
            ...
            <section class="editor-panel glass">
              ...
              <!-- 信纸背景区域 + textarea -->
              <div class="paper-wrap" :style="{ background: selectedPaper.gradient }" :class="{ 'is-night': app.isNight.value && selectedPaper.key === 'starry' }">
                <textarea
                  ref="textareaRef"
        ...
        <div v-if="showSuccess" class="modal-overlay" @click.self="showSuccess = false">
          <div class="modal-card pop-scale">
            ...
            <div class="modal-actions">
              <a href="/treehole" class="btn-grad">🏠 返回广场</a>
              <a href="/treehole/mine" class="chip">📬 我的信箱</a>
