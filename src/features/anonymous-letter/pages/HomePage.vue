    ...
    <div class="app-root">
      ...
      <header class="top-nav glass">
        <div class="nav-inner">
          ...
          <nav class="nav-links" aria-label="主导航">
            <a href="/treehole" class="nav-link active">广场</a>
      ...
      <transition name="slide-down">
        <nav v-if="mobileMenuOpen" class="mobile-menu glass" aria-label="移动端导航" @click="mobileMenuOpen = false">
          <a href="/treehole" class="mobile-nav-link active">🏠 广场</a>
      ...
      <main class="main-content float-up">
        <div class="container">
          ...
          <section class="hero glass float-up">
            ...
            <div class="hero-acts">
              <a href="/treehole/write" class="btn-grad">✍️ 写一封信</a>
              <a href="/treehole/random" class="chip">🎲 随机树洞</a>
            </div>
          </section>
      ...
      <nav class="bottom-nav glass" aria-label="移动端底部导航">
        <a href="/treehole" class="bn-item active">
