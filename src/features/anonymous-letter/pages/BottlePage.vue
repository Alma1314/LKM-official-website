    ...
    <div class="app-root">
      ...
      <header class="top-nav glass">
        <div class="nav-inner">
          ...
          <nav class="nav-links" aria-label="主导航">
            ...
            <a href="/treehole/bottle" class="nav-link active">漂流瓶</a>
      ...
      <transition name="slide-down">
        <nav v-if="mobileMenuOpen" class="mobile-menu glass" aria-label="移动端导航" @click="mobileMenuOpen = false">
          ...
          <a href="/treehole/bottle" class="mobile-nav-link active">🍾 漂流瓶</a>
      ...
      <nav class="bottom-nav glass" aria-label="移动端底部导航">
        ...
        <a href="/treehole/bottle" class="bn-item active">
          <span class="bn-icon">🍾</span>
