...
| 产品A | 10 |`;
    ...
    expect(table.content![0].content![0].content![0].content![0]).toEqual({
      type: "text",
      text: "名称",
    });
  ...
  it("公式（行内与块级）往返", () => {
          ...
          content: [
            {
              type: "text",
              text: "E=mc^2",
              marks: [{ type: "inlineMath", attrs: { latex: "E=mc^2" } }],
            },
          ],
        },
        {
    ...
    expect((inline.marks ?? []).some((m) => m.type === "inlineMath")).toBe(
      true,
    );
      ...
      content: [
        {
          ...
          content: [
            {
              type: "wikiLink",
              attrs: { href: "/docs/my-doc", label: "我的文档" },
            },
            { type: "text", text: " 见" },
          ],
        },
