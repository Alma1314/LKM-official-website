...
export const mockProjects: MockProject[] = [
  {
    ...
    progress: 40,
    recruitingRoles: ['前端开发', 'UI 设计师'],
    team: [{ name: '七月O', role: '发起人' }],
    tags: ['量子计算', 'Web 开发', '教育'],
    isIncubated: true,
    isPinned: true,
    isRecruiting: true,
  ...
  },
  {
    ...
    teamIntro: '',
    progress: 20,
    recruitingRoles: ['后端开发', '内容编辑'],
    team: [{ name: '七月墨染', role: '发起人' }],
    tags: ['知识图谱', 'Python', '社区'],
    isIncubated: false,
    isPinned: false,
    isRecruiting: true,
  ...
  },
  {
    ...
    team: [
      { name: '天文爱好者', role: '发起人' },
      { name: '数据工程师小张', role: '数据处理' },
    ],
    tags: ['天文', '数据可视化', 'Three.js'],
    isIncubated: false,
    isPinned: false,
    isRecruiting: false,
    reports: [
