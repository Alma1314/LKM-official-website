...
export const mockProjects: MockProject[] = [
  {
    ...
    progress: 40,
    recruitingRoles: ['projectData.roles.frontend', 'projectData.roles.uiDesigner'],
    team: [{ name: 'projectData.names.qiyueO', role: 'projectData.teamRoles.initiator' }],
    tags: ['projectData.tags.quantumComputing', 'projectData.tags.webDev', 'projectData.tags.education'],
    isIncubated: true,
    isPinned: true,
    isRecruiting: true,
    reports: [
  ...
  },
  {
    ...
    progress: 20,
    recruitingRoles: ['projectData.roles.backend', 'projectData.roles.contentEditor'],
    team: [{ name: 'projectData.names.qiyueMoran', role: 'projectData.teamRoles.initiator' }],
    tags: ['projectData.tags.knowledgeGraph', 'projectData.tags.python', 'projectData.tags.community'],
    isIncubated: false,
    isPinned: false,
    isRecruiting: true,
    reports: [
  ...
  },
  {
    ...
    recruitingRoles: [],
    team: [
      { name: 'projectData.names.qiyueHua', role: 'projectData.teamRoles.generalPlanner' },
      { name: 'projectData.names.wang', role: 'projectData.teamRoles.animation' },
      { name: 'projectData.names.li', role: 'projectData.teamRoles.voice' },
    ],
    tags: ['projectData.tags.popularScience', 'projectData.tags.video', 'projectData.tags.education'],
    isIncubated: true,
    isPinned: false,
    isRecruiting: false,
    reports: [
  ...
  },
  {
    ...
    recruitingRoles: [],
    team: [
      { name: 'projectData.names.astronomyFan', role: 'projectData.teamRoles.initiator' },
      { name: 'projectData.names.zhang', role: 'projectData.teamRoles.dataProcessing' },
    ],
    tags: ['projectData.tags.astronomy', 'projectData.tags.dataVisualization', 'projectData.tags.threeJs'],
    isIncubated: false,
    isPinned: false,
    isRecruiting: false,
    reports: [
