...
export const adminStats: AdminStat[] = [
  { label: 'adminData.stats.users', value: 156, change: 'adminData.stats.usersChange', icon: 'tabler:users' },
  { label: 'adminData.stats.posts', value: 42, change: 'adminData.stats.postsChange', icon: 'tabler:article' },
  {
  ...
  { label: 'adminData.stats.pendingReports', value: 3, change: '', icon: 'tabler:flag' },
];
