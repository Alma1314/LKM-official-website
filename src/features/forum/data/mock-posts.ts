...
- Feynman, *The Feynman Lectures on Physics*, Vol. III`,
    authorId: 'author-qiyue-o',
    authorName: '七月O',
    categoryId: 'physics-astronomy',
    tags: ['量子力学', '物理学', '入门教程'],
    isPinned: true,
    isFeatured: true,
    viewCount: 2340,
...
- 视频教程：B站搜索"围棋入门"
- 对弈平台：野狐围棋、腾讯围棋`,
    authorId: 'author-demo3',
    authorName: '棋友小明',
    categoryId: 'hobby-chess',
    tags: ['围棋', '入门', '棋牌'],
    isPinned: false,
    isFeatured: false,
    viewCount: 670,
...
export const mockComments: MockComment[] = [
  {
    ...
    postId: 'post-1',
    authorName: '物理系学生',
    content: '写得非常清晰！请问能再出一期关于量子谐振子的文章吗？',
    floorNumber: 1,
    likeCount: 15,
  ...
  },
  {
    ...
    postId: 'post-1',
    authorName: '七月O',
    content: '谢谢支持！量子谐振子已经在计划中了，会涵盖代数法和解析法两种求解方式。',
    floorNumber: 2,
    parentId: 'c1',
    likeCount: 8,
  ...
  },
  {
    ...
    postId: 'post-1',
    authorName: '量子萌新',
    content: '有个小问题：为什么波函数必须归一化？不归一化会怎样？',
    floorNumber: 3,
    likeCount: 3,
  ...
  },
  {
    ...
    postId: 'post-1',
    authorName: '数学物理方法',
    content: '因为波函数的模方表示概率密度，全空间的概率必须为 1。归一化就是确保这个概率解释成立。',
    floorNumber: 4,
    parentId: 'c3',
    likeCount: 10,
  ...
  },
  {
    ...
    postId: 'post-3',
    authorName: '竞赛新人',
    content: '想问一下，第一次参加数模竞赛，需要准备多长时间？',
    floorNumber: 1,
    likeCount: 5,
  ...
  },
  {
    ...
    postId: 'post-3',
    authorName: '七月花',
    content: '建议至少提前 2-3 个月开始准备。前两个月系统学习+练习，最后一个月模拟真题。',
    floorNumber: 2,
    parentId: 'c5',
    likeCount: 12,
  ...
  },
  {
    ...
    postId: 'post-5',
    authorName: '天文爱好者',
    content: '大赞！这些数据集太有用了，终于有人整理了一份中文说明',
    floorNumber: 1,
    likeCount: 22,
  ...
  },
  {
    ...
    postId: 'post-7',
    authorName: '研一菜鸟',
    content: '三遍阅读法真的很实用！用了两周感觉效率提升明显。',
    floorNumber: 1,
    likeCount: 18,
  ...
  },
  {
    ...
    postId: 'post-7',
    authorName: '留学生小明',
    content: '补充一个工具：Grammarly 可以帮助检查写作，特别是学术写作语气。',
    floorNumber: 2,
    likeCount: 7,
  ...
  },
  {
    ...
    postId: 'post-2',
    authorName: '数据分析新手',
    content: '写得很好！能不能再加一个数据清洗的例子？实际工作中清洗最花时间',
    floorNumber: 1,
    likeCount: 9,
