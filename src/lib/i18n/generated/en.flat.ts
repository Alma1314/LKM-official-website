...
export const enFlat = {
  ...
  "contributionData.pointLogs.post": "Post: Quantum Mechanics Introduction",
  ...
  "page.apps.triggeredDischarge.description": "Real-time GPU lightning simulation. Laplace field solving, dielectric breakdown growth, Heidler return-stroke waveform, MTLE current decay, procedural thunder — a fully physics-driven visualization experiment.",
  ...
  "page.official.triggeredDischarge.branchNotePrefix": "Growth probability p ∝ E",
  "page.official.triggeredDischarge.branchNoteSuffix": "reproduces the branch sparsity of real lightning (η = 1 collapses into a compact fractal cluster). The return-stroke current travels up the channel with a Heidler waveform at c/3 (MTLE model, λ = 2 km); each stage runs on the physical clock, slowed by the multiplier above.",
  "page.official.triggeredDischarge.channelLength": "Channel Length",
  "page.official.triggeredDischarge.charging": "Charging",
  "page.official.triggeredDischarge.clickHint": "Click anywhere to trigger lightning",
  ...
  "page.official.triggeredDischarge.metaDescription": "Real-time GPU lightning simulation: Laplace field solving, dielectric breakdown growth, Heidler return-stroke waveform, MTLE current decay, volume rendering, bloom, and procedural thunder.",
  "page.official.triggeredDischarge.metaTitle": "Triggered Discharge — 2D Dielectric Breakdown Simulation",
  ...
  "page.official.triggeredDischarge.signature": "Real-time simulation — real physics, no shortcuts",
  ...
  "page.official.triggeredDischarge.webgpuLine1": "This simulation solves the 2D Laplace field equation on the GPU every frame.",
  "page.official.triggeredDischarge.webgpuLine2": "Use Chrome, Edge, or Brave 113+ (or Safari 18+), with WebGPU enabled.",
